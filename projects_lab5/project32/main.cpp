...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh1->LoadMesh("C:/dev/projects/Content/phoenix_ugv.md2")) {
            return false;            
        }
        
        m_pMesh2 = new Mesh();

        if (!m_pMesh2->LoadMesh("C:/dev/projects/Content/jeep.obj")) {
            return false;            
        }

        m_pMesh3 = new Mesh();

        if (!m_pMesh3->LoadMesh("C:/dev/projects/Content/hheli.obj")) {
            return false;            
        }
